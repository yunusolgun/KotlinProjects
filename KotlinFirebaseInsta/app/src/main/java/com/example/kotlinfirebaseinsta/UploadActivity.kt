...
class UploadActivity : AppCompatActivity() {
    ...
    fun uploadClicked(view: View) {
        ...
        if (selectedPicture != null) {
            imagesReference.putFile(selectedPicture!!).addOnSuccessListener { taskSnopshot ->

                //Database - Firestore
                val uploadedPictureReferecence = FirebaseStorage.getInstance().reference.child("images").child(imageName)
                uploadedPictureReferecence.downloadUrl.addOnSuccessListener { uri ->
